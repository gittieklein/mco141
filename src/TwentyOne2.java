...
public class TwentyOne2
{
	public static void main(String[] args)
	{
		...
		do
		{
			...
			//this loop will iterate 2 times generating 
			...
			//tell the user his score from his 2 staring 
			//cards before his first turn
			System.out.println("You start off the game with 2 cards. \nYour score is " + playerScore + ".");
			
			while (playerScore < 21 || houseScore < 15)
			{
				//players turn
				selection = gameMenu();
				...
				/*if the player or the house has more than 21, the game should end then
				because whoever has more than 21 already lost. this has to be checked
				after the player's turns and after the computer's turns*/
				...
				else if (playerScore > 21 || selection == 2)
				{
					winner(houseScore, playerScore);
					break;
				}
	...
	*/
	...
	public static void gameRules()
	{
		System.out.println("Welcome to the game of \"21\". \nYou start with 2 cards and aim to get as close to 21 as "
				...
				+ " of the house: \nThe house (computer) will continue to draw cards as long a its score is less than"
